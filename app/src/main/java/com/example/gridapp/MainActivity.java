...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<Integer>mImageIds=new ArrayList<>(Arrays.asList(R.drawable.img1,R.drawable.img2,R.drawable.img3,
    ...
    public void ShowDialogBox(int item_pos){
        ...
        TextView Image_name=dialog.findViewById(R.id.txt_ImageName);
        ...
        //Extracting the name of the image selected
